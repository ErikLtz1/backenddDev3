...
public class StompControllerTest {
    ...
    public void testAddFirstPlayer() {
        ...
        assertEquals("/hunter.png", playerResult.get(0).getColour());
    ...
    public void testAddSecondPlayer() {
        ...
        assertEquals("/witch.png", playerResult.get(1).getColour());
    ...
    public void testAddThirdPlayer() {
        ...
        assertEquals("/zombie.png", playerResult.get(2).getColour());
    ...
    public void testAddFourthPlayer() {
        ...
        assertEquals("/viking.png", playerResult.get(3).getColour());
